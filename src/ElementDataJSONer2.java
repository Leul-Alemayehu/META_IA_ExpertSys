...
public class ElementDataJSONer2 extends JFrame {
    ...
    private void saveToJSON() {
        try {
            JSONObject newElementProp = new JSONObject();
            // Meta Properties
            newElementProp.put("symbol", symbolField.getText());
            newElementProp.put("group", groupComboBox.getSelectedItem().toString());
            newElementProp.put("period", periodComboBox.getSelectedItem().toString());

            // Physical Properties
            newElementProp.put("atomicNumber", atomicNumberField.getText());
            newElementProp.put("atomicMass", atomicMassField.getText());
            newElementProp.put("stateOfMatter", stateOfMatterField.getText());
            newElementProp.put("color", convertToJSONArray(colorField.getText()));
            newElementProp.put("density", densityField.getText());
            newElementProp.put("meltingPoint", meltingPointField.getText());
            newElementProp.put("boilingPoint", boilingPointField.getText());
            newElementProp.put("electricalConductivity", electricalConductivityComboBox.getSelectedItem().toString());
            newElementProp.put("thermalConductivity", thermalConductivityComboBox.getSelectedItem().toString());
            newElementProp.put("crystalStructure", crystalStructureField.getText());
            newElementProp.put("refractiveIndex", refractiveIndexField.getText());
            newElementProp.put("magnetism", magnetismComboBox.getSelectedItem().toString());

            // Chemical Properties
            newElementProp.put("reactivity", reactivityComboBox.getSelectedItem().toString());
            newElementProp.put("oxideAcidityBasicity", acidityBasicityComboBox.getSelectedItem().toString());
            newElementProp.put("reactionWithWater", reactionWaterComboBox.getSelectedItem().toString());
            newElementProp.put("reactionWithAcids", reactionAcidsComboBox.getSelectedItem().toString());
            newElementProp.put("reactionWithOxygen", reactionOxygenComboBox.getSelectedItem().toString());
            newElementProp.put("oxidationStates", convertToJSONArray(oxidationStatesField.getText()));
            newElementProp.put("electronegativity", electronegativityField.getText());
            newElementProp.put("electronConfiguration", electronConfigurationField.getText());
            newElementProp.put("ionizationEnergy", ionizationEnergyField.getText());
            newElementProp.put("allotropeCount", allotropicFormsField.getText());

            // Special Properties
            newElementProp.put("radioactivity", radioactivityComboBox.getSelectedItem().toString());
            newElementProp.put("isotopeCount", isotopeCountField.getText());
            newElementProp.put("flameTestColor", flameTestColorField.getText());
            newElementProp.put("toxicity", toxicityComboBox.getSelectedItem().toString());
            newElementProp.put("corrosionResistance", corrosionResistanceComboBox.getSelectedItem().toString());
            newElementProp.put("hardness", hardnessField.getText());

            JSONObject newElementProParir = new JSONObject(); // this line will map the Element name and the properties list.
            newElementProParir.put(nameField.getText(), newElementProp);
            // Read existing file and append new data
            JSONArray elementsArray;
            try {
                String filePath = "workfiles/elementsandproperties_EKA.json";
            ...
            elementsArray.put(newElementProParir);

            // Write updated data back to the file
            try (FileWriter file = new FileWriter("workfiles/elementsandproperties3.json")) {
